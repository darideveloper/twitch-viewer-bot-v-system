...
class WebScraping ():
    ...
    def __init__(self, web_page="", headless=False, time_out=0,
        ...
        Args:
            web_page (str, optional): Web page to open when starts. Defaults to "".
            ...
            cookies (dict, optional): Cookies to load in the browser. Defaults to {}.
        """
        ...
        # Load cookies
        if self.__cookies__:
            cookies_formatted = self.__format_cookies__(self.__cookies__)
            for cookie in cookies_formatted:
                self.driver.add_cookie(cookie)

    def __format_cookies__(self, cookies: dict) -> list:
